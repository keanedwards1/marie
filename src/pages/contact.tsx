...
import DOMPurify from "dompurify"; // ✅ Ensuring input sanitization
...
export default function ContactPage() {
  ...
  // ✅ Hardcoded API URL to always use NIP domain
  const API_URL = "https://159.89.233.75.nip.io/api/send-email";
  ...
  return (
    <div className="min-h-screen flex flex-col relative">
      ...
      <div className="flex-grow md:p-8 p-4 lg:p-12 flex -pb-12 flex-col items-center">
        <h1 className="text-4xl mb-8 font-serif font-bold text-[#2e2e2e]">Contact Me</h1>
