...
const LeftImage: React.FC<LeftImageProps> = ({className}) => {
  return (
    <div className={`right-image-styles w-full lg:w-7/12 flex justify-center items-center lg:pt-8 lg:pl-2 lg:pr-6 pr-8 pl-8 pb-4 pt-4 relative order-1 lg:order-2 ${className}`}>
